...
public class AprobarAfiliacionHandler {
  ...
  @Transactional
  public void handle(AprobarAfiliacionCommand cmd) {
    ...
    agg.aprobar(cmd.adminGlobalId(), cmd.observaciones(), domainEvents);
